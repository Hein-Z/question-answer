...
{{--        @endif--}}
            ...
            <div class="mt-8 bg-white dark:bg-gray-800 container shadow sm:rounded-lg">
                <div class="grid grid-cols-1">
                    <div class="text-center h1 font-weight-bolder py-3 bg-gray-100 border-bottom border-dark mx-0">
                        All Question
                    </div>
                    @foreach($questions as $question)
                        <div class="row border-dark border-bottom">
                            <div class="col-1 py-5 px-0">
                            ...
                            <div class="py-5 col-11 px-0">
                                <div class="flex items-center d-flex flex-column align-items-start ">
                                    <div class="ml-4 text-lg leading-7 font-semibold"><a
                                            ...
                                            href="{{$question->url}}">{{$question->title}}</a></div>
